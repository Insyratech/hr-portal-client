...
export function HolidaysPage() {
  const canManage = useAppSelector((state) =>
    state.permissions.permissions.includes(PERMISSIONS.HOLIDAYS_MANAGE),
  );
    ...
    <>
      ...
      {!canManage ? (
        <p className="mb-6 text-sm text-muted">
          General Manager maintains the holiday calendar. This list is read-only for everyone else.
        </p>
      ) : null}
