import type { InventoryStationPrint } from '@/types/api';
...
/** Opens a printable station QR label (stock-room plastic picker). */
export function printInventoryStationLabel(payload: InventoryStationPrint): void {
  const { station, scanUrl, labelTitle } = payload;
  ...
  * { box-sizing: border-box; }
  ...
  <div class="card">
    ...
    <div class="copy">
      ...
      <p class="code">Station QR</p>
      <p>${esc(station.locationName)} (${esc(station.locationCode)})</p>
      <p>Pick plastic type, size, boxes</p>
