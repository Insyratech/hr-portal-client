...
/** Slim employee row for finance officer pickers (not full HR directory). */
...
/** Phase 0–1 inventory shell from GET /api/v1/inventory/overview. */
